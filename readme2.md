...
| ------------ | -------- | ---------------------------------------- |
| 10.129.0.101 | node1    | kube-apiserver, kube-controller-manager, kube-scheduler, etcd, kubelet, docker, flannel, dashboard |
| 10.129.0.102 | node2    | kubelet, docker, flannel、traefik         |
| 10.129.0.103 | node3    | kubelet, docker, flannel                 |

The default setting will create the private network from 10.129.0.101 to 10.129.0.103 for nodes, and it will use the host's DHCP for the public IP.
...
Kubernetes dashboard URL: <https://10.129.0.101:8443>
...
mkdir certs
openssl req -nodes -newkey rsa:4096 -keyout certs/dashboard.key -out certs/dashboard.csr -subj "/C=/ST=/L=/O=/OU=/CN=kubernetes-dashboard"
...
```ini
10.129.0.102 grafana.jimmysong.io
```
...
```ini
10.129.0.102 traefik.jimmysong.io
```
...
```
10.129.0.102 grafana.istio.jimmysong.io
10.129.0.102 prometheus.istio.jimmysong.io
10.129.0.102 servicegraph.istio.jimmysong.io
10.129.0.102 jaeger-query.istio.jimmysong.io
```
...
| productpage  | http://10.129.0.101:31380/productpage                        |
...
Kiali web: http://10.129.0.101:32439
...
```
10.129.0.102 scope.weave.jimmysong.io
```
